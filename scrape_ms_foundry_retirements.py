...
# -*- coding: utf-8 -*-
"""
Scrape Microsoft's Foundry "model deprecations and retirements" page and:
  1) Extract models from the "Upcoming retirements" section
  2) Save a clean CSV with a "Type" column
...
Usage:
  python scrape_ms_foundry_retirements.py
  python scrape_ms_foundry_retirements.py --only text        # (optional) focus on text only
  python scrape_ms_foundry_retirements.py --outdir ./out     # change output dir
"""
import argparse
import csv
...
MS_URL_BASE = "https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/model-lifecycle-retirement"
# We parse a single page that contains the Upcoming retirements for Foundry models section broken down by subsections.
